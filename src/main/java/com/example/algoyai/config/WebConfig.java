...
public class WebConfig {
	...
	/**
	 * ai-frontend.url 프로퍼티 값을 주입받아 저장하는 변수입니다.
	 * 이 변수에는 프론트엔드 애플리케이션의 URL이 저장됩니다.
	 */
	...
	public WebMvcConfigurer corsConfigurer() {
		return new WebMvcConfigurer() {
			 ...
			 * "/ai/**" 경로에 대해 지정된 프론트엔드 URL에서의 접근을 허용하며,
			 * GET, POST, PUT, DELETE, OPTIONS 메서드를 사용할 수 있게 허용합니다.
			 * 또한, 모든 헤더와 자격 증명(Credentials)을 허용합니다.
			 *
			...
			public void addCorsMappings(CorsRegistry registry) {
				registry.addMapping("/ai/**")
					.allowedOrigins("http://15.165.235.170", "http://15.165.235.170:8081", "http://localhost:8081")
